	...
	<nav>
		...
		<div class="main-navigation">
			...
			<ul class="main-navigation-a">
				...
				$new = array_splice($array,3,1);
				array_splice($array,2,0,$new);
				...
				foreach ($array as $key => $file) {
					...
					if ($page_name == $page) {
						echo '<li><strong class="'.contact_bg($file).'">'.$page.'</strong></li>';
					}
					else {
						echo '<li><a href="'.$file.'" class="'.contact_bg($file).'">'.$page.'</a></li>';
					}
				}
